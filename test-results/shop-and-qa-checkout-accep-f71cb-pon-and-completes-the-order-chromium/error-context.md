...
- Name: shop-and-qa.spec.js >> checkout accepts an admin coupon and completes the order
- Location: tests\e2e\shop-and-qa.spec.js:33:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5174/checkout
Call log:
  - navigating to "http://127.0.0.1:5174/checkout", waiting until "load"
