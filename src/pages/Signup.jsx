        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md">
          ...
          <div className="card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-xs text-gray-400">By signing up, you agree to our <a href="/terms" className="text-brand-500">Terms</a> and <a href="/privacy" className="text-brand-500">Privacy Policy</a>.</p>
